...
> September 14: TestFlight **0.1.0 (23)** is available to the existing internal testing group; the external group is **Waiting for Review**. It includes group voice/video calls, video-call screen sharing and the latest chat corrections, plus the calendar purpose metadata required after build 22 failed Apple processing. [Build evidence](docs/BUILD_LOG.md) · [Behavior and validation](docs/BUILD_22.md).
